...
export default class TextTable extends Sprite {
  ...
  onAdded() {
    let staticStyle = this.ss = new TextStyle('Fredoka One', 0xe85656, 35, TextStyle.FontStyle.NORMAL, TextStyle.FontWeight.BOLD, 4, 0xfffdd4);
    staticStyle.dropShadow = true;
    staticStyle.shadowColor = 0x000000;
    staticStyle.shadowDistanceX = 5;
    staticStyle.shadowDistanceY = 4;
    staticStyle.shadowBlur = 4;
